...
from transformers_electra import ElectraConfig, ElectraForQuestionAnsweringAVPool, ElectraTokenizer
from transformers_electra import AdamW, get_linear_schedule_with_warmup, squad_convert_examples_to_features
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False):
    ...
    cached_features_file = os.path.join(input_dir, 'av_reader_cached_{}_{}_{}_{}'.format(
...
def main():
    ...
    print('model_path:', args.config_name if args.config_name else args.model_name_or_path)
