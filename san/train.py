...
# checkpoint_dict = torch.load("/home/work/project/keypoint/san_mrc-master/checkpoint/checkpoint_last.pt") # finetune
# set environment
...
def main():
    ...
    # model = DocReaderModel(opt, embedding, state_dict =checkpoint_dict["state_dict"]) #Finetune
    model = DocReaderModel(opt, embedding) # normal train
    # model meta str
